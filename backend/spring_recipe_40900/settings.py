"""
Django settings for spring_recipe_40900 project.
...
ROOT_URLCONF = 'spring_recipe_40900.urls'
...
WSGI_APPLICATION = 'spring_recipe_40900.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "spring_recipe_40900 API",
    "DESCRIPTION": "API documentation for spring_recipe_40900 App",
    "VERSION": "v1",
}
